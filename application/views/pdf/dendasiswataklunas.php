...
$pdf->SetTitle('Denda Siswa Tidak Lunas');
$pdf->SetSubject('Denda Siswa Tidak Lunas');
...
$html.='<table>
	<tbody>
		<tr>
			<td style="text-align: center; line-height:30px;"><h2>Denda Siswa Tidak Lunas</h2></td>
		</tr>
	</tbody>
</table>
<table border="1" cellspacing="0" cellpadding="3">
	<thead>
		<tr>
			...
			<th style="text-align: center;" width="500"><b>Nama Siswa</b></th>
			<th style="text-align: center;" width="200"><b>Kelas</b></th>
			<th style="text-align: center;" width="251"><b>Status Denda</b></th>
		</tr>
	</thead>
	<tbody>';
	foreach ($dendaSiswa->result() as $dataSiswa) {
		...
		$html .='<tr>
			...
			<td width="500">'.$dataSiswa->nama_siswa.'</td>
			<td style="text-align: center;" width="200">'.$dataSiswa->kelas.'</td>
			<td style="text-align: center;" width="251">'.$dataSiswa->status_denda.'</td>
		</tr>';
	}
	$html .='</tbody>
</table>';
