...
$pdf->SetTitle('Rekap Data Siswa Tidak Aktif');
$pdf->SetSubject('Rekap Data Siswa Tidak Aktif');
...
$html.='<table>
	<tbody>
		<tr>
			<td style="text-align: center; line-height:30px;"><h2>Rekap Data Siswa Tidak Aktif</h2></td>
		</tr>
	</tbody>
</table>
<table border="1" cellspacing="0" cellpadding="3">
	...
	foreach ($siswa->result() as $dataSiswa) {
		...
		$html .='<tr>
			...
			<td style="text-align: center;" width="251">'.$dataSiswa->status.'</td>
		</tr>';
	}
	$html .='</tbody>
</table>';
