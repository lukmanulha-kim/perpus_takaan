...
$pdf->SetTitle('Rekap Data Buku Rusak');
$pdf->SetSubject('Rekap Data Buku Rusak');
...
$html.='<table>
	<tbody>
		<tr>
			<td style="text-align: center; line-height:30px;"><h2>Data Buku Dengan Kondisi Rusak</h2></td>
		</tr>
	</tbody>
</table>
...
$pdf->Output('Rekap Data Buku Rusak.pdf', 'I');
