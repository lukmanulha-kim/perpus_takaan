...
$pdf->SetTitle('Rekap Data Buku Baik');
$pdf->SetSubject('Rekap Data Buku Baik');
...
$html.='<table>
	<tbody>
		<tr>
			<td style="text-align: center; line-height:30px;"><h2>Data Buku Dengan Kondisi Baik</h2></td>
		</tr>
	</tbody>
</table>
...
$pdf->Output('Rekap Data Buku Baik.pdf', 'I');
