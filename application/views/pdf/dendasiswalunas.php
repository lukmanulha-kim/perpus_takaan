...
$pdf->SetTitle('Denda Siswa Lunas');
$pdf->SetSubject('Denda Siswa Lunas');
...
$html.='<table>
	<tbody>
		<tr>
			<td style="text-align: center; line-height:30px;"><h2>Denda Siswa Lunas</h2></td>
		</tr>
	</tbody>
</table>
<table border="1" cellspacing="0" cellpadding="3">
	<thead>
		<tr>
			...
			<th style="text-align: center;" width="400"><b>Nama Siswa</b></th>
			<th style="text-align: center;" width="200"><b>Kelas</b></th>
			<th style="text-align: center;" width="150"><b>Pustakawan</b></th>
			<th style="text-align: center;" width="201"><b>Status Denda</b></th>
		</tr>
	</thead>
	<tbody>';
	foreach ($dendaSiswa->result() as $dataSiswa) {
		@$no++;
		$html .='<tr>
			<td style="text-align: center; width:30;">'.$no.'</td>
			<td width="400">'.$dataSiswa->nama_siswa.'</td>
			<td style="text-align: center;" width="200">'.$dataSiswa->kelas.'</td>
			<td style="text-align: center;" width="150">'.$dataSiswa->nama_pustakawan.'</td>
			<td style="text-align: center;" width="201">'.$dataSiswa->status_denda.'</td>
		</tr>';
	}
	$html .='</tbody>
</table>';
