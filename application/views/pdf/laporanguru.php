...
<table border="1" cellspacing="0" cellpadding="3">
	<thead>
		<tr>
			...
			<th style="text-align: center; " width="190"><b>Nama Guru</b></th>
			<th style="text-align: center;" width="310"><b>Judul Buku</b></th>
	...
	foreach ($laporan->result() as $dataLaporan) {
		...
		$html .='<tr>
			...
			<td width="190">'.$dataLaporan->nama_guru.'</td>
			<td style="text-align: center;" width="310">'.$dataLaporan->judul_buku.'</td>
