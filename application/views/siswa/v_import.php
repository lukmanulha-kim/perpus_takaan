	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Import Data Siswa</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="alert bg-info" role="alert">
					<svg class="glyph stroked sound on"><use xlink:href="#stroked-sound-on"/></svg> Silahkan Download Template Import Data Siswa, <a href="<?php echo base_url('templateimport/FormatUploadDataSiswa.xlsx') ?>" title="Template Import Data Siswa">disini.</a>
				</div>
					...
					<div class="panel-body">
						<form method="post" action="<?php echo base_url('index.php/siswa/upload') ?>" enctype="multipart/form-data">
							<div class="form-group">
								...
								<p class="help-block">Silahkan Download Template Import Data Siswa, <a href="<?php echo base_url('templateimport/FormatUploadDataSiswa.xlsx') ?>" title="Template Import Data Siswa">disini.</a></p>
							</div>
		                ...
		                if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
		                  ...
		                  echo "<form method='post' action='".base_url("index.php/siswa/doimport")."'>";
		                  ...
		                  foreach($sheet as $row){ 
		                    ...
		                    if($numrow > 1){
		                      ...
		                      $kelas_td = ( ! empty($kelas))? "" : " style='background: #E07171;'"; // Jika NISN kosong, beri warna merah
